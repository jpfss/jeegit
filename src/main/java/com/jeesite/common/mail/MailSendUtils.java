...
public class MailSendUtils {
	 ...
	 *             地址异常
	 */
	public boolean sendTextMail(MailBody mailInfo) throws MessagingException, AddressException {
		/**
		 * 判断是否需要身份认证
		 */
		...
		/**
		 * logBefore(logger, "构造一个发送邮件的session"); 根据session创建一个邮件消息
		 */
	 ...
	 *             消息异常
	 */
	public boolean sendHtmlMail(MailBody mailInfo) throws AddressException, MessagingException {
		/**
		 * 判断是否需要身份认证
		 */
		MailAuthenticator authenticator = null;
	...
	public static boolean sendEmail(String SMTP, String PORT, String EMAIL, String PAW, String toEMAIL, String TITLE,
			String CONTENT, String TYPE) throws AddressException, MessagingException {
